...
#ifndef LIB_WINDOWS_LIST_HPP_
#define LIB_WINDOWS_LIST_HPP_
...
const GUID GUID_DEVICE_INTERFACE_STORAGEPORT = {
    ...
    0xC130,
    0x11D2,
    {0xB0, 0x82, 0x00, 0xA0, 0xC9, 0x1E, 0xFB, 0x8B}};

const std::set<std::string> USB_STORAGE_DRIVERS{
    "USBSTOR", "UASPSTOR", "VUSBSTOR",  "RTUSER",
    "CMIUCR",  "EUCR",     "ETRONSTOR", "ASUSSTPT"};

const std::set<std::string> GENERIC_STORAGE_DRIVERS{
    "SCSI",   "SD",       "PCISTOR",  "RTSOR",    "JMCR",
    "JMCF",   "RIMMPTSK", "RIMSPTSK", "RIXDPTSK", "TI21SONY",
