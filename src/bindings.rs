...
pub const _MSVC_STL_UPDATE: u32 = 201906;
...
pub type std_underlying_type_type<_Ty> = _Ty;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std__Invoke_traits {
    pub _address: u8,
}
pub type std__Invoke_traits__Is_invocable = std_false_type;
pub type std__Invoke_traits__Is_nothrow_invocable = std_false_type;
pub type std__Invoke_traits__Is_invocable_r = std_false_type;
pub type std__Invoke_traits__Is_nothrow_invocable_r = std_false_type;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type std__Invoke_result_t = std__Invoke_traits;
pub type std__Is_invocable_r_ = std__Invoke_traits;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
pub type std__Conditionally_enabled_hash_result_type = usize;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std_hash {
    pub _address: u8,
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std__Allow_inheriting_unwrap {
    pub _base: std_true_type,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std__Range_verifiable {
    pub _base: std_false_type,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std__Unwrappable {
    pub _base: std_false_type,
}
pub type std__Unwrapped_t = std__Remove_cvref_t;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std__Do_unwrap_when_unverified {
    pub _base: std_false_type,
}
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std__Offset_verifiable {
    pub _base: std_false_type,
}
pub type std__Unwrapped_n_t = std__Remove_cvref_t;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct std__Wrapped_seekable {
    pub _base: std_false_type,
}
...
pub type std__Array_const_iterator_difference_type = isize;
pub type std__Array_const_iterator_pointer<_Ty> = *const _Ty;
pub type std__Array_const_iterator_reference<_Ty> = *const _Ty;
pub const std__Array_const_iterator__EEN_SIZE: std__Array_const_iterator__bindgen_ty_1 = 0;
pub type std__Array_const_iterator__bindgen_ty_1 = i32;
...
pub type std__Array_iterator_difference_type = isize;
pub type std__Array_iterator_pointer<_Ty> = *mut _Ty;
pub type std__Array_iterator_reference<_Ty> = *mut _Ty;
pub const std__Array_iterator__EEN_SIZE: std__Array_iterator__bindgen_ty_1 = 0;
pub type std__Array_iterator__bindgen_ty_1 = i32;
...
pub type std_move_iterator__Ref0 = std_iterator_traits;
...
pub type std_pointer_traits__Reftype = std_conditional_t;
...
pub type std__Default_allocator_traits_size_type = usize;
...
pub type std__Simple_types_size_type = usize;
...
#[repr(C)]
#[derive(Debug)]
pub struct Drivelist_MountPoint {
    pub path: std_string,
}
#[test]
fn bindgen_test_layout_Drivelist_MountPoint() {
    assert_eq!(
        ::std::mem::size_of::<Drivelist_MountPoint>(),
        32usize,
        concat!("Size of: ", stringify!(Drivelist_MountPoint))
    );
    assert_eq!(
        ::std::mem::align_of::<Drivelist_MountPoint>(),
        8usize,
        concat!("Alignment of ", stringify!(Drivelist_MountPoint))
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Drivelist_MountPoint>())).path as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(Drivelist_MountPoint),
            "::",
            stringify!(path)
        )
    );
...
#[repr(C)]
#[derive(Debug)]
pub struct Drivelist_DeviceDescriptor {
    pub enumerator: std_string,
    pub busType: std_string,
    pub busVersion: std_string,
    pub busVersionNull: bool,
    pub device: std_string,
    pub devicePath: std_string,
    pub devicePathNull: bool,
    pub raw: std_string,
    pub description: std_string,
    pub error: std_string,
    pub size: u64,
    pub blockSize: u32,
    pub logicalBlockSize: u32,
    pub mountpoints: std_vector,
    pub mountpointLabels: std_vector,
    pub isReadOnly: bool,
    pub isSystem: bool,
    pub isVirtual: bool,
...
#[test]
fn bindgen_test_layout_Drivelist_DeviceDescriptor() {
    assert_eq!(
        ::std::mem::size_of::<Drivelist_DeviceDescriptor>(),
        352usize,
        concat!("Size of: ", stringify!(Drivelist_DeviceDescriptor))
    );
    assert_eq!(
        ::std::mem::align_of::<Drivelist_DeviceDescriptor>(),
        8usize,
        concat!("Alignment of ", stringify!(Drivelist_DeviceDescriptor))
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).enumerator as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(Drivelist_DeviceDescriptor),
            "::",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).busType as *const _ as usize
        },
        32usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).busVersion as *const _ as usize
        },
        64usize,
        concat!(
            "Offset of field: ",
            stringify!(Drivelist_DeviceDescriptor),
            "::",
            stringify!(busVersion)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).busVersionNull as *const _
                as usize
        },
        96usize,
        concat!(
            ...
            stringify!(Drivelist_DeviceDescriptor),
            "::",
            stringify!(busVersionNull)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).device as *const _ as usize
        },
        104usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).devicePath as *const _ as usize
        },
        136usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).devicePathNull as *const _
                as usize
        },
        168usize,
        concat!(
            ...
            stringify!(Drivelist_DeviceDescriptor),
            "::",
            stringify!(devicePathNull)
        )
    );
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).raw as *const _ as usize },
        176usize,
        concat!(
            "Offset of field: ",
            stringify!(Drivelist_DeviceDescriptor),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).description as *const _ as usize
        },
        208usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).error as *const _ as usize
        },
        240usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).size as *const _ as usize },
        272usize,
        concat!(
            "Offset of field: ",
            stringify!(Drivelist_DeviceDescriptor),
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).blockSize as *const _ as usize
        },
        280usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).logicalBlockSize as *const _
                as usize
        },
        284usize,
        concat!(
            ...
            stringify!(Drivelist_DeviceDescriptor),
            "::",
            stringify!(logicalBlockSize)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).mountpoints as *const _ as usize
        },
        288usize,
        concat!(
            "Offset of field: ",
            stringify!(Drivelist_DeviceDescriptor),
            "::",
            stringify!(mountpoints)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).mountpointLabels as *const _
                as usize
        },
        312usize,
        concat!(
            ...
            stringify!(Drivelist_DeviceDescriptor),
            "::",
            stringify!(mountpointLabels)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).isReadOnly as *const _ as usize
        },
        336usize,
        concat!(
            "Offset of field: ",
            stringify!(Drivelist_DeviceDescriptor),
            "::",
            stringify!(isReadOnly)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).isSystem as *const _ as usize
        },
        337usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).isVirtual as *const _ as usize
        },
        338usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).isRemovable as *const _ as usize
        },
        339usize,
        concat!(
            "Offset of field: ",
            stringify!(Drivelist_DeviceDescriptor),
            "::",
            stringify!(isRemovable)
        )
    );
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).isCard as *const _ as usize
        },
        340usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).isSCSI as *const _ as usize
        },
        341usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).isUSB as *const _ as usize
        },
        342usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).isUAS as *const _ as usize
        },
        343usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe {
            &(*(::std::ptr::null::<Drivelist_DeviceDescriptor>())).isUASNull as *const _ as usize
        },
        344usize,
        concat!(
            "Offset of field: ",
...
extern "C" {
    #[link_name = "\u{1}?ListStorageDevices@Drivelist@@YA?AV?$vector@UDeviceDescriptor@Drivelist@@V?$allocator@UDeviceDescriptor@Drivelist@@@std@@@std@@XZ"]
    pub fn Drivelist_ListStorageDevices() -> std_vector;
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
