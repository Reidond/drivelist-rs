...
use winapi::shared::minwindef::{BOOL, DWORD, HLOCAL, PBYTE};
use winapi::shared::ntdef::NULL;
use winapi::shared::winerror::S_OK;
use winapi::um::errhandlingapi::GetLastError;
use winapi::um::setupapi::{
  SetupDiGetDeviceRegistryPropertyA, HDEVINFO, SPDRP_HARDWAREID, SPDRP_REMOVAL_POLICY,
  SP_DEVINFO_DATA,
};
...
use winapi::um::winnt::{LPWSTR, PWSTR};

use device_descriptor::DeviceDescriptor;

use crate::constants::{
  GENERIC_STORAGE_DRIVERS, KNOWN_FOLDER_IDS, USB_STORAGE_DRIVERS, VHD_HARDWARE_IDS,
};
...
fn is_virtual_hard_drive(h_device_info: HDEVINFO, device_info_data: *mut SP_DEVINFO_DATA) -> bool {
  ...
  let has_hardware_id: BOOL = unsafe {
